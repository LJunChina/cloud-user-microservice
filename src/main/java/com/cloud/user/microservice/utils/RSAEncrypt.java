...
import com.cloud.user.microservice.exception.RSAEncryptException;
...
public class RSAEncrypt {
    ...
    public static void genKeyPair(String filePath) {
        ...
        try {
            ...
            logger.error("generator key occurred exception {}",e);
    ...
    private static void closeResources(BufferedWriter pubbw, BufferedWriter pribw, FileWriter pubfw, FileWriter prifw) {
        if(null != pubbw){
            try {
                ...
                logger.error("close resource occurred exception {}",e);
            }
        }
        if(null != pubfw){
            try {
